...
{
    public class UsuarioDesbloquearConsumerMOA
    {
        SI_MPMF_MOAOP_LOGIN_DESBUSRClient service = new SI_MPMF_MOAOP_LOGIN_DESBUSRClient();
        ...
        public LoginWSMOAResponse request(string usuario)
        {
            try
            {
                ...
                Z_MPMF_MOAOP_LOGINResponse response = service.SI_MPMF_MOAOP_LOGIN_DESBUSR(requestInfo);
