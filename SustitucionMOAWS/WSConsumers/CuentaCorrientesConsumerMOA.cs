...
namespace SustitucionMOAWS.WSConsumers
{
    public abstract class CuentaCorrientesConsumerMOABase<T>
    {
        ...
        public T Request(string compensa, string proveedor, string sociedad, FechaWS fecha, string contrato, string pago, string retencion)
        {
            try
            {
                if (ConfigurationManager.AppSettings["SAPsinPI"] == "1")
                {
                    ...
                    var fechaSAP = new WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4100
                    {
                ...
                {
                    var fechaSAP = new CuentaCorrienteWebServiceMOA.ZMPES4100
                    {
                        FECHA_OP = SAPFormatter.PrepararFecha(fecha.fechaInicio),
                        FECHA_OP_HASTA = SAPFormatter.PrepararFecha(fecha.fechaFin)
                    };
                    ...
                    compensa = string.IsNullOrWhiteSpace(pago) ? compensa : "X";
                    var error = service.SI_MPMF_MOAOP_CUENTA_CORRIENTE(compensa, contrato, fechaSAP, pago, proveedor, retencion, sociedad, out CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas);
        ...
        protected abstract T Map(CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas, CuentaCorrienteWebServiceMOA.ZMPES4910 error, DateTime fechaFin);
        protected abstract T MapSinPI(WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120[] salidas, WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4910 error, DateTime fechaFin);

    }

    public class CuentaCorrientesConsumerMOA : CuentaCorrientesConsumerMOABase<CuentaCorrienteWSMOAResponse>
    {
        protected override CuentaCorrienteWSMOAResponse Map(CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas, CuentaCorrienteWebServiceMOA.ZMPES4910 error, DateTime fechaFin)
        {
            ...
            foreach (CuentaCorrienteWebServiceMOA.ZMPES6120 cuentaCorrienteInfo in salidas)
            {
        ...
        protected override CuentaCorrienteWSMOAResponse MapSinPI(WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120[] salidas, WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4910 error, DateTime fechaFin)
        {
            var result = new CuentaCorrienteWSMOAResponse();
            if (error != null)
            {
            ...
            foreach (WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120 cuentaCorrienteInfo in salidas)
            {
                var fechaVencimientoStr = string.IsNullOrEmpty(cuentaCorrienteInfo.PAGO_DIF_ARP)
                    ? cuentaCorrienteInfo.FEC_VTO
                    : cuentaCorrienteInfo.FECHA_PAGO_DIF_ARP;
    ...
    {
        protected override CuentaCorrienteExcelWSMOAResponse Map(CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas, CuentaCorrienteWebServiceMOA.ZMPES4910 error, DateTime fechaFin)
        {
        ...
        protected override CuentaCorrienteExcelWSMOAResponse MapSinPI(WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120[] salidas, WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4910 error, DateTime fechaFin)
        {
            var result = new CuentaCorrienteExcelWSMOAResponse();
            if (error != null)
            {
    ...
    {
        protected override CuentaCorrienteAgrupadaWSMOAResponse Map(CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas, CuentaCorrienteWebServiceMOA.ZMPES4910 error, DateTime fechaFin)
        {
        ...
        protected override CuentaCorrienteAgrupadaWSMOAResponse MapSinPI(WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120[] salidas, WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4910 error, DateTime fechaFin)
        {
            var result = new CuentaCorrienteAgrupadaWSMOAResponse();
            if (error != null)
            {
    ...
    {
        protected override CuentaCorrienteAgrupadaExcelWSMOAResponse Map(CuentaCorrienteWebServiceMOA.ZMPES6120[] salidas, CuentaCorrienteWebServiceMOA.ZMPES4910 error, DateTime fechaFin)
        {
        ...
        protected override CuentaCorrienteAgrupadaExcelWSMOAResponse MapSinPI(WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES6120[] salidas, WS_GAQ_sin_PI_DIRECT_MOAOP.ZMPES4910 error, DateTime fechaFin)
        {
            var result = new CuentaCorrienteAgrupadaExcelWSMOAResponse();
            if (error != null)
            {
