...
namespace SustitucionMOAWS.WSConsumers
{
    public class ObtenerSolpConsumerMOA : IObtenerSolpConsumerMOA
    {
        ...
        public ObtenerSolpSAPResponse RequestSolpWithNroAndDates(ObtenerSolpRequest req)
        {
            try
            {
                ...
                if (ConfigurationManager.AppSettings["SAPsinPI"] == "1")
                {
                    ...
                    var request = new Z_MMRFC_OBTENER_SOLPED()
                    {
                        IM_ACCOUNT_ASSIGNMENT = IM_ACCOUNT_ASSIGNMENT,
                        IM_ACCTASSCAT = string.Empty,
                        IM_CREATE_IND = string.Empty,
                        IM_DELETE_IND = IM_DELETE_TEXT,
                        IM_DELIVERY_ADDRESS = IM_DELIVERY_ADDRESS,
                        IM_HEADER_TEXT = IM_HEADER_TEXT,
                        IM_ITEM_CAT = string.Empty,
                        IM_ITEM_TEXT = IM_ITEM_TEXT,
                        IM_PLANT = string.Empty,
                        IM_PREQ_DATE_F = IM_PREQ_DATE_F,
                        IM_PREQ_DATE_I = IM_PREQ_DATE_I,
                        IM_PREQ_NO = IM_PREQ_NO,
                        IM_REL_IND = string.Empty,
                ...
                else
                {
                    ...
                    ObtenerSolpWebServiceMOA.ZMPES5640[] IM_USUARIOS = new ObtenerSolpWebServiceMOA.ZMPES5640[0];
                    ...
                    var result = service.SI_MMRFC_OBTENER_SOLPED(
                                ...
                                IM_USUARIOS,
                                out string EX_EXITO,
                                out ObtenerSolpWebServiceMOA.ZMPES5740[] EX_PRACCOUNT,
                                out ObtenerSolpWebServiceMOA.ZMPES7110[] EX_PRADDRDELIVERY,
                                out ObtenerSolpWebServiceMOA.ZMPES7120[] EX_PRCOMPONENTS,
                                out ObtenerSolpWebServiceMOA.ZMPES7140[] EX_PRHEADERTEXT,
                                out ObtenerSolpWebServiceMOA.ZMPES5670[] EX_PRITEM,
                                out ObtenerSolpWebServiceMOA.ZMPES7130[] EX_PRIMETEXT,
                                out ObtenerSolpWebServiceMOA.BAPIRETURN[] EX_RETURN,
                                out ObtenerSolpWebServiceMOA.ZMPES5770[] EX_SERVICEACCOUNT,
                                out ObtenerSolpWebServiceMOA.ZMPES5730[] EX_SERVICELINES);
                    ...
                    */
                    var archivos = result.ToList() ?? new List<ObtenerSolpWebServiceMOA.ZMPES7100>();
        ...
        private ObtenerSolpSAPResponse MapSinPI(Z_MMRFC_OBTENER_SOLPEDResponse response) //EX_PRHEADERTEXT
        {
            /*
                ObtenerSolpWebServiceMOA.ZMPES5740[] tipoImputaciones, //EX_PRACCOUNT
                ObtenerSolpWebServiceMOA.ZMPES7110[] direccionesPosicion, //EX_PRADDRDELIVERY
                ObtenerSolpWebServiceMOA.ZMPES7120[] eX_PRCOMPONENTS, //eX_PRCOMPONENTS
                ObtenerSolpWebServiceMOA.ZMPES5670[] posiciones, //EX_PRITEM
                ObtenerSolpWebServiceMOA.BAPIRETURN[] mensajes, //EX_RETURN
                ObtenerSolpWebServiceMOA.ZMPES5770[] imputacionesSuposiciones, //EX_SERVICEACCOUNT
                ObtenerSolpWebServiceMOA.ZMPES5730[] suposicionesServicios,
                List<ObtenerSolpWebServiceMOA.ZMPES7100> archivos,
                ObtenerSolpWebServiceMOA.ZMPES7140[] textosCabecera             
             
             */

            var result = new ObtenerSolpSAPResponse();
            var tipoImputaciones = response.EX_PRACCOUNT;
            var direccionesPosicion = response.EX_PRADDRDELIVERY;
            var eX_PRCOMPONENTS = response.EX_PRCOMPONENTS;
            var posiciones = response.EX_PRITEM;
            var mensajes = response.EX_RETURN;
            var imputacionesSuposiciones = response.EX_SERVICEACCOUNT;
            ...
            */
            ...
            foreach (var posicion in posiciones)
            {
                result.Posiciones.Add(new PosicionSolpSAP
                {
                    ...
                    OrganizacionDeCompraId = posicion.PURCH_ORG
                });
            }
        ...
        private ObtenerSolpSAPResponse Map(ObtenerSolpWebServiceMOA.ZMPES5740[] tipoImputaciones, //EX_PRACCOUNT
                                           ...
                                           ObtenerSolpWebServiceMOA.ZMPES5730[] suposicionesServicios,
                                           List<ObtenerSolpWebServiceMOA.ZMPES7100> archivos,
                                           ObtenerSolpWebServiceMOA.ZMPES7140[] textosCabecera) //EX_PRHEADERTEXT
        {
            var result = new ObtenerSolpSAPResponse();
