...
namespace SustitucionMOAWS.WSConsumers
{
    public class OrdenCargaConsumerMOA : IOrdenCargaConsumerMOA
    {
        ...
        */
        ...
        private const string TipoContratoFas_CuentaYOrden = "C";
        ...
        */
        ...
        private string ConvertirATipoContratoFasSAP(TipoContratoFAS? tipoContrato)
        {
            ...
            switch (tipoContrato)
            {
                ...
                case TipoContratoFAS.CuentaYOrden: return TipoContratoFas_CuentaYOrden;
        ...
        private TipoContratoFAS ConvertirDeTipoContratoFasSAP(string tipoContrato)
        {
            switch (tipoContrato)
            {
                ...
                case TipoContratoFas_CuentaYOrden: return TipoContratoFAS.CuentaYOrden;
