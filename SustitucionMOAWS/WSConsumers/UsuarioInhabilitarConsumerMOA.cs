...
{
    public class UsuarioInhabilitarConsumerMOA
    {
        SI_MPMF_MOAOP_LOGIN_INHAUSRClient service = new SI_MPMF_MOAOP_LOGIN_INHAUSRClient();
        ...
        public LoginWSMOAResponse request(string usuario)
        {
            try
            {
                ...
                Z_MPMF_MOAOP_LOGINResponse response = service.SI_MPMF_MOAOP_LOGIN_INHAUSR(requestInfo);
