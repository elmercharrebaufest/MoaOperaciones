...
namespace SustitucionMOAWS.WSConsumers
{
    public class PagoDetalleConsumerMOA
    {
        ...
        public object request(string proveedor, string pago)
        {
            try
            {
                ZMPES4360[] cabeceras = new ZMPES4360[] { };
                ZMPES5320[] salidas = new ZMPES5320[] { };
                ZMPES5320[] salidasExcelDetalle = new ZMPES5320[] { };
                ZMPES4510[] vendedores = new ZMPES4510[] { };
        ...
        protected virtual object map(ZMPES4360[] cabeceras, ZMPES5320[] salidas, ZMPES4510[] vendedores, string pago, string proveedor)
        {
            string moneda = "$";
            ...
            foreach (ZMPES4360 cabecera in cabeceras)
            {
            ...
            foreach (ZMPES4510 vendedor in vendedores)
            {
    ...
    {
        protected override object map(ZMPES4360[] cabeceras, ZMPES5320[] salidas, ZMPES4510[] vendedores, string pago, string proveedor)
        {
            string moneda = "$";
