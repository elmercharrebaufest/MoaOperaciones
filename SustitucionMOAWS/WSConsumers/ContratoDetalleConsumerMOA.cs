...
namespace SustitucionMOAWS.WSConsumers
{
    public class ContratoDetalleConsumerMOA
    {
        ...
        public object request(string proveedor, string contrato)
        {
            try
            {
                ZMPES4390[] ampliaciones_anulaciones = new ZMPES4390[] { };
                ZMPES4400[] aplicaciones = new ZMPES4400[] { };
                ZMPES4410[] calidad = new ZMPES4410[] { };
                ZMPES4410[] calidadExcelDetalle = new ZMPES4410[] { };
                ZMPES6200[] caracteristicas = new ZMPES6200[] { };
                ZMPES4710[] condiciones_pago = new ZMPES4710[] { };
                ZMPES4380[] fijaciones = new ZMPES4380[] { };
                ZMPES4420[] hijos = new ZMPES4420[] { };
                ZMPES6210[] liquidaciones = new ZMPES6210[] { };
                ZMPES4360[] pagos = new ZMPES4360[] { };
                ZMPES4520[] resumenes = new ZMPES4520[] { };
                string error;

                service.ClientCredentials.UserName.UserName = SAPCredential.getUserName();
                service.ClientCredentials.UserName.Password = SAPCredential.getPassword();
                ZMPES5260 boleto = service.SI_MPMF_MOAOP_DETALLES_CONTRATO(contrato, proveedor, ref ampliaciones_anulaciones, ref aplicaciones, ref calidad, ref caracteristicas, ref condiciones_pago, ref fijaciones, ref hijos, ref liquidaciones, ref pagos, ref resumenes, out error);
        ...
        protected virtual object map(string contrato, string error, ZMPES5260 boleto, ZMPES4390[] ampliaciones_anulaciones, ZMPES4400[] aplicaciones, ZMPES4410[] calidades, ZMPES6200[] caracteristicas, ZMPES4710[] condiciones_pago, ZMPES4380[] fijaciones, ZMPES4420[] hijos, ZMPES6210[] liquidaciones, ZMPES4360[] pagos, ZMPES4520[] resumenes)
        {
            ...
            foreach (ZMPES4390 ampAnul in ampliaciones_anulaciones)
            {
            ...
            foreach (ZMPES4400 aplicacion in aplicaciones)
            {
            ...
            foreach (ZMPES4410 calidad in calidades)
            {
            ...
            foreach (ZMPES6200 caracteristica in caracteristicas)
            {
            ...
            foreach (ZMPES4710 condicionPago in condiciones_pago)
            {
                result.condicionesPago.Add(condicionPago.MENSAJE);
            }

            foreach (ZMPES4380 fijacion in fijaciones)
            {
            ...
            foreach (ZMPES4420 hijo in hijos)
            {
            ...
            foreach (ZMPES4360 pago in pagos)
            {
            ...
            foreach (ZMPES4520 resumen in resumenes)
            {
    ...
    {
        protected override object map(string contrato, string error, ZMPES5260 boleto, ZMPES4390[] ampliaciones_anulaciones, ZMPES4400[] aplicaciones, ZMPES4410[] calidades, ZMPES6200[] caracteristicas, ZMPES4710[] condiciones_pago, ZMPES4380[] fijaciones, ZMPES4420[] hijos, ZMPES6210[] liquidaciones, ZMPES4360[] pagos, ZMPES4520[] resumenes)
        {
