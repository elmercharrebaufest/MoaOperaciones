...
{
    public class UsuarioOlvidePassConsumerMOA
    {
        SI_MPMF_MOAOP_LOGIN_OLVPASSClient service = new SI_MPMF_MOAOP_LOGIN_OLVPASSClient();
        ...
        public LoginWSMOAResponse request(string usuario)
        {
            try
            {
                ...
                Z_MPMF_MOAOP_LOGINResponse response = service.SI_MPMF_MOAOP_LOGIN_OLVPASS(requestInfo);
