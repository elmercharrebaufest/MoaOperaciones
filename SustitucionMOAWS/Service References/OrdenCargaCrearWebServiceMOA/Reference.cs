...
namespace SustitucionMOAWS.OrdenCargaCrearWebServiceMOA {
    ...
    public partial class SI_MPMF_MOAOP_CREAR_ORDEN_CARGARequest {
        ...
        public SI_MPMF_MOAOP_CREAR_ORDEN_CARGARequest(string IM_CLIENTE, string IM_CONTRATO, string IM_CORREDOR, decimal IM_KILOS, string IM_MATERIAL, string IM_PEDIDO) {
