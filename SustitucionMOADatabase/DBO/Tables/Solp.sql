CREATE TABLE [dbo].[Solp] (
    ...
    [PliegoMultiplePliegoOriginal_Id] INT NULL,
    ...
    CONSTRAINT [FK_Solp_PliegoMultiplePliegoOriginal] FOREIGN KEY ([PliegoMultiplePliegoOriginal_Id]) REFERENCES [dbo].[Pliego] ([Id]),
