CREATE TABLE [dbo].[CotizacionSubPosicion] (
    ...
    CONSTRAINT [FK.CotizacionSubPosicion_CotizacionPosicion_CotizacionPosicion_Id] FOREIGN KEY ([CotizacionPosicion_Id]) REFERENCES [CotizacionPosicion]([Id]) ON DELETE CASCADE,
