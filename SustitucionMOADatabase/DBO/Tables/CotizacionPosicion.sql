CREATE TABLE [dbo].[CotizacionPosicion] (
    ...
    CONSTRAINT [FK.CotizacionPosicion_PeticionDeOfertaSolpPosicion_PeticionDeOfertaSolpPosicion_Id] FOREIGN KEY ([PeticionDeOfertaSolpPosicion_Id]) REFERENCES [PeticionDeOfertaSolpPosicion]([Id]) ON DELETE NO ACTION,
