...
IF NOT EXISTS (SELECT TOP 1 1 FROM HabilitacionJob WHERE Nombre = 'EnviarMailReporteTrabajoYaHecho') BEGIN    INSERT into HabilitacionJob VALUES ('EnviarMailReporteTrabajoYaHecho',1)END
