    ...
    public class OrdenDeCargaService : OrdenDeCargaServiceBase, IOrdenDeCargaService
    {
        ...
        public Resultado Editar(OrdenDeCarga ordenDeCarga, string mailUsuario)
        {
            ...
            try
            {
                ...
                if (puedeEnviarASAP && ordenEditar.NumeroEntrega != null)
                {
                    ...
                    var resultadoSAP = ordenCargaConsumer.ModificarEntregaOrdenCarga(new ModificarEntregaOrdenCargaSAP(ordenEditar));
        ...
        public string EdicionFinalizada(int ordenId, string mailUsuario)
        {
            try
            {
                ...
                {
                    var resultado = ordenCargaConsumer.ModificarEntregaOrdenCarga(new ModificarEntregaOrdenCargaSAP(orden));
        ...
        {
            if (ordenDeCarga.EsFacturaAnticipada && ordenDeCarga.SinSeleccionarFactura && _facturaAnticipadaService.OrdenConMultiplesFacturas(ordenDeCarga))
            {
        ...
        private bool ValidarKgDisponiblesEnviaDirectamenteASAP(OrdenDeCarga orden, Usuario usuario)
        {
            ...
            if (!esInterno)
            {
                ...
                var ordenesPendientes = ObtenerOrdenesPendientes(numeroContrato);
