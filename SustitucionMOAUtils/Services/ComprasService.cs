...
namespace SustitucionMOAUtils.Services
{
    public class ComprasService : IComprasService
    {
        ...
        {
            Solp solp = repositorio.Obtener<Solp>(idSolp);
        ...
        private SolpSAPDto ConvertirSOLPSAP(Solp solpActual)
        {
