...
namespace SustitucionMOAUtils.Services
{
    public class ConsultaService : IConsultaService
    {
        ...
        public ConsultaService(IRepositorio repositorio, IAzureService azureService, ITimeProvider timeProvider, IConsultaContext consultaContext, IGestionImpuestosService gestionImpuestosService, IConsultaCommon consultaCommon)
        {
        ...
        public List<ConsultaDto> ObtenerConsultasPorProveedor(int usuarioId, string vendedor, bool obtenerTodos)
        {
            ...
            ret = repositorio.Listar<Consulta>(x => (obtenerTodos && categorias.Contains(x.Categoria.Id)) && x.CodigoProveedor == vendedor && x.EstadoConsulta_Id == (int)EstadosConsulta.SolicitudInformacion, includes: includes)
                .Select(x => new ConsultaDto
                {
                    Id = x.Id,
                    Asunto = x.Asunto,
