...
namespace SustitucionMOAUtils.Interfaces
{
    public interface IOrdenDeCargaService
    {
        ...
        List<ClienteSAP> GetClientesVigentesSAP(string fechaIni, string fechaFin);
        List<SustitucionMOAModel.Entities.Proveedor> FiltrarNoExistentesWeb(List<ClienteSAP> clientes);
    }
}
