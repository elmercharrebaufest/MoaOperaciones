...
export class CartaPorteFormularioComponent extends ListBaseComponent {
    ...
    public spinnerSmallImpTempComponent: SpinnerSmallComponent;

    @ViewChild("sp_imp_blanco")
    public spinnerSmallImpBlancoComponent: SpinnerSmallComponent;

    @ViewChild("sp_ctg_buscar")
    public spinnerSmallCTGBuscarComponent: SpinnerSmallComponent;
