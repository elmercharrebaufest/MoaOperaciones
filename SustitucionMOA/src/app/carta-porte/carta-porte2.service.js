...
var CartaPorteService = /** @class */ (function (_super) {
    ...
    CartaPorteService.prototype.getCartasPorteCommon = function (periodo, fecha_inicio, fecha_fin, method) {
        ...
        return this.http
            .get('/api/cartaporte/' + method, { search: params, headers: this.headers }).pipe(timeoutWith(30000, observableThrowError(new Error("Por favor, restrinja el rango de fechas"))), map(this.extractData));
    };
    CartaPorteService.prototype.getDetalle = function (cartaPorteId) {
        var params = new URLSearchParams();
        params.set('cartaPorteId', cartaPorteId);
        return this.http
            .get('/api/cartaporte/getDetalle', { search: params, headers: this.headers }).pipe(timeoutWith(30000, observableThrowError(new Error("Por favor, restrinja el rango de fechas"))), map(this.extractData));
    };
    ...
    CartaPorteService.prototype.exportExcelCommon = function (periodo, fecha_inicio, fecha_fin, method) {
        ...
        params.set('fechaFin', fecha_fin);
        return this.http
            .get('/api/cartaporte/' + method, { search: params, headers: this.headers }).pipe(timeoutWith(60000, observableThrowError(new Error("Por favor, restrinja el rango de fechas"))), map(this.extractData));
    };
    CartaPorteService.prototype.exportExcelDetalle = function (cartaPorteId) {
        var params = new URLSearchParams();
        params.set('cartaPorteId', cartaPorteId);
        return this.http
            .get('/api/cartaporte/downloadDetalle', { search: params, headers: this.headers }).pipe(timeoutWith(60000, observableThrowError(new Error("Por favor, restrinja el rango de fechas"))), map(this.extractData));
    };
    CartaPorteService.prototype.exportPDFCalidad = function (numero_ccpp) {
        var params = new URLSearchParams();
        params.set('numeroCCPP', numero_ccpp);
        return this.http
            .get('/api/cartaporte/exportPDFCalidad', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    CartaPorteService.prototype.getFotos = function (cartaPorteId) {
        var params = new URLSearchParams();
        params.set('cartaPorteId', cartaPorteId);
        return this.http
            .get('/api/cartaporte/GetFotos', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    CartaPorteService.prototype.getListaFotos = function (cartaPorteIds) {
        var params = new URLSearchParams();
        params.set('cartaPorteIds', cartaPorteIds);
        return this.http
            .get('/api/cartaporte/GetListaFotos', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    CartaPorteService.prototype.descargarFotos = function (cartaPorteIds) {
        var params = new URLSearchParams();
        params.set('cartaPorteIds', cartaPorteIds);
        return this.http
            .get('/api/cartaporte/DescargarFotos', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
...
export { CartaPorteDescargaService };
...
export { CartaPorteAplicacionService };
var CartaPorteFormularioService = /** @class */ (function (_super) {
    ...
    CartaPorteFormularioService.prototype.getFormularioDropdowns = function () {
        return this.http
            .get('/api/cartaporte/getFormularioDropdowns', { headers: this.headers }).pipe(map(this.extractData));
    };
    CartaPorteFormularioService.prototype.getDataCTG = function (valor) {
        var params = new URLSearchParams();
        params.set('valor', valor);
        return this.http
            .get('/api/cartaporte/getDataCTG', { search: params, headers: this.headers }).pipe(timeoutWith(30000, observableThrowError(new Error("Por favor, intentelo nuevamente"))), map(this.extractData));
    };
...
export { CartaPorteFormularioService };
//# sourceMappingURL=carta-porte2.service.js.map