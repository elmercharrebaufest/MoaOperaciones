...
var LiquidacionNGObservadaComponent = /** @class */ (function (_super) {
    ...
    LiquidacionNGObservadaComponent = __decorate([
        Component({
            ...
            templateUrl: "liquidacion.no-granos.observada.component.html",
            providers: [{ provide: LiquidacionService, useClass: LiquidacionNGObservadaService }]
        }),
        __metadata("design:paramtypes", [LiquidacionNGObservadaService, NavService, SessionDataService, SecurityService, FloatMsgService, ModalService])
    ], LiquidacionNGObservadaComponent);
    return LiquidacionNGObservadaComponent;
}(LiquidacionNGBaseComponent));
export { LiquidacionNGObservadaComponent };
