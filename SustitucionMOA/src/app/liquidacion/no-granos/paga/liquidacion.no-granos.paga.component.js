...
var LiquidacionNGPagaComponent = /** @class */ (function (_super) {
    ...
    LiquidacionNGPagaComponent = __decorate([
        Component({
            ...
            templateUrl: "liquidacion.no-granos.paga.component.html",
            providers: [{ provide: LiquidacionService, useClass: LiquidacionNGPagaService }]
        }),
        __metadata("design:paramtypes", [LiquidacionNGPagaService, NavService, SessionDataService, SecurityService, FloatMsgService, ModalService])
    ], LiquidacionNGPagaComponent);
    return LiquidacionNGPagaComponent;
}(LiquidacionNGBaseComponent));
export { LiquidacionNGPagaComponent };
