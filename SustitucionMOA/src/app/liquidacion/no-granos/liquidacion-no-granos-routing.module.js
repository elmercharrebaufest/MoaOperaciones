...
var LiquidacionNoGranosRoutingModule = /** @class */ (function () {
    function LiquidacionNoGranosRoutingModule() {
    }
    LiquidacionNoGranosRoutingModule = __decorate([
        NgModule({
            imports: [RouterModule.forChild(routes)],
            exports: [RouterModule]
        })
    ], LiquidacionNoGranosRoutingModule);
    return LiquidacionNoGranosRoutingModule;
}());
export { LiquidacionNoGranosRoutingModule };
//# sourceMappingURL=liquidacion-no-granos-routing.module.js.map