...
var DatoFiscalService = /** @class */ (function (_super) {
    ...
    DatoFiscalService.prototype.getDatosFiscales = function (vendedor) {
        ...
        return this.http
            .get('/api/vendedor/getDatoFiscales', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    DatoFiscalService.prototype.getVendedores = function (fecha_inicio, fecha_fin) {
        ...
        return this.http
            .get('/api/vendedor/getVendedores', { search: params }).pipe(timeoutWith(30000, observableThrowError(new Error("Tiempo de respuesta agotado, por favor intentar nuevamente"))), map(this.extractData));
    };
