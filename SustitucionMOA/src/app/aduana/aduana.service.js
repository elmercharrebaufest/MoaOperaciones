...
var AduanaService = /** @class */ (function (_super) {
    ...
    AduanaService.prototype.getPesada = function (centro, fecha_inicio, fecha_fin) {
        ...
        params.set('fechaFin', fecha_fin);
        return this.http
            .get('/api/aduana/getPesada', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    AduanaService.prototype.getPesadaDetalle = function (centro, nroOrden) {
        ...
        return this.http
            .get('/api/aduana/getPesadaDetalle', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    AduanaService.prototype.getImagenCamaraConsolidacion = function (url, nombre) {
        ...
        return this.http
            .get('/api/aduana/obtenerImagenCamaraConsolidacion', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
