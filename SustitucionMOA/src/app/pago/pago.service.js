...
var PagoService = /** @class */ (function (_super) {
    ...
    PagoService.prototype.getDetalle = function (numero_pago) {
        ...
        return this.http
            .get('/api/pago/getDetalle', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
    ...
    PagoService.prototype.exportExcelDetalle = function (numero_pago) {
        ...
        params.set('numeroPago', numero_pago);
        return this.http
            .get('/api/pago/downloadDetalle', { search: params, headers: this.headers }).pipe(map(this.extractData));
    };
