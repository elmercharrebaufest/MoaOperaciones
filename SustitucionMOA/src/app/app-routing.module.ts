...
const appRoutes: Routes = [
...

    {
        ...
        children: [
            ...
            { path: "carta-porte", loadChildren: "./carta-porte/carta-porte.module#CartaPorteModule" },
            { path: "comprobante-ngs", loadChildren: "./liquidacion/no-granos/liquidacion-no-granos.module#LiquidacionNoGranosModule" },
            ...
            { path: "cuenta-corriente", loadChildren: "./cuenta-corriente/cuenta-corriente.module#CuentaCorrienteModule" },
            { path: "dato-fiscal", loadChildren: "./dato-fiscal/dato-fiscal.module#DatoFiscalModule" },
            { path: "flete", loadChildren: "./flete/flete.module#FleteModule" },
            { path: "home", component: HomeComponent },
            { path: "home-ngs", component: HomeNGSComponent },
            { path: "liquidacion", loadChildren: "./liquidacion/liquidacion.module#LiquidacionModule" },
            { path: "no-autorizado", component: NoAutorizadoComponent },
            { path: "pago", loadChildren: "./pago/pago.module#PagoModule" },
            { path: "pago-ngs", loadChildren: "./pago/no-granos/pago-no-granos.module#PagoNoGranosModule" },
            ...
            { path: "alta-empresa-granos/:id", component: EmpresaGranosComponent },
            ...
            { path: "crear-contrato", loadChildren: "./crear-contrato/crear-contrato.module#CrearContratoModule" },
            { path: "sustentable", loadChildren: "./venta-sustentable/venta-sustentable.module#VentaSustentableModule" },
            { path: "ordenes-de-carga", loadChildren: "./ordenes-de-carga/ordenes-de-carga.module#OrdenesDeCargaModule", data: { tipoOperacion: 'Normal' }},
            { path: "ordenes-de-carga-cyo", loadChildren: "./ordenes-de-carga/ordenes-de-carga.module#OrdenesDeCargaModule", data: { tipoOperacion: 'CyO' }},
            { path: "ordenes-de-carga-fason", loadChildren: "./ordenes-de-carga-fason/ordenes-de-carga-fason.module#OrdenesDeCargaFasonModule" },
            { path: "ordenes-residuos", loadChildren: "./ordenes-residuos/ordenes-residuos.module#OrdenesResiduosModule" },
            { path: "reporte-contrato", loadChildren: "./reporte-contrato/reporte-contrato.module#ReporteContratoModule" },
