...
export class EspecificacionesViewModel {
    ...
    readonly valorPorDefecto: string ="<p>3.b - Consideraciones particulares:</p><p>3.b.1 Especificación  técnica:</p><p><span class=\"ql-size-small\">Especificación técnica de la obra, generalidades, detalles, puntos de control, planos, diagramas , etc.</span></p>";
