...
var CargaPesadasComponent = /** @class */ (function (_super) {
    ...
    function CargaPesadasComponent(service, navService, securityService, sessionDataService, floatMsgService, modalService) {
        ...
        _this.mensajeTopComponent = new MensajeComponent();
        _this.mensajeBottomComponent = new MensajeComponent();
        _this.spinnerTopComponent = new SpinnerComponent();
        _this.spinnerBottomComponent = new SpinnerComponent();
        return _this;
    }
    ;
    ...
    CargaPesadasComponent = __decorate([
        Component({
            ...
            templateUrl: "carga-pesadas.component.html",
            providers: [RYDService]
        }),
        __metadata("design:paramtypes", [RYDService, NavService, SecurityService, SessionDataService, FloatMsgService, ModalService])
    ], CargaPesadasComponent);
    return CargaPesadasComponent;
}(RYDBaseComponent));
export { CargaPesadasComponent };
