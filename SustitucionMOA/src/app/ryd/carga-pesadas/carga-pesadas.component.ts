...
export class CargaPesadasComponent extends RYDBaseComponent implements OnDestroy  {
    ...
    public validarEncabezado(fecha: string) {
        try {
            this.setAllMsgsEmpty();
