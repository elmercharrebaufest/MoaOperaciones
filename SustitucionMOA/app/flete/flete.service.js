...
var FleteService = /** @class */ (function (_super) {
    ...
    FleteService.prototype.getDataCommon = function (periodo, fecha_inicio, fecha_fin, method) {
        ...
        return this.http
            .get('/api/flete/' + method, { search: params, headers: this.headers })
    ...
    FleteService.prototype.guardarDatosProforma = function (data, file) {
        ...
        return this.http
            .post('/api/flete/guardarDatosProforma', payload, this.headersPost)
            .map(this.extractData);
    };
...
exports.FleteService = FleteService;
...
exports.FletePendienteService = FletePendienteService;
var FleteAFacturarService = /** @class */ (function (_super) {
    ...
    FleteAFacturarService.prototype.validarImporte = function (importe, proforma) {
        ...
        params.set('proforma', proforma);
        return this.http
            .get('/api/flete/validarImporte', { search: params, headers: this.headers })
            .map(this.extractData);
    };
...
exports.FleteAFacturarService = FleteAFacturarService;
...
exports.FleteFacturadoService = FleteFacturadoService;
