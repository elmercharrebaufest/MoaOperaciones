...
namespace SustitucionMOATest.Services
{
    ...
    public class ComprasServiceTest
    {
        ...
        public void GrabarAdjudicacionMaterialOk()
        {
            ...
            usuarioServiceMock.Setup(x => x.GrabarProveedor(It.IsAny<ProveedorDto>(), EstadoAprobacion.Aprobado, false)).Returns(new ResultadoGenerico { ProveedorDto = new ProveedorDto { Id = 1 } });
...
.Returns(new List<SolpPosicion> { new SolpPosicion { Indice = 1, Cantidad = 22, FechaEntregaServicio = DateTime.Now, Solp = new Solp { NroSolp = "1" } } });
        ...
        public void ActualizarFechaLiberacionOCOk()
        {
            ...
            repositorioMock.Setup(y => y.Obtener(It.IsAny<Expression<Func<Configuracion, bool>>>())).Returns(new Configuracion { Code = "EnvioMailLiberacionOC", Value = "1" });
