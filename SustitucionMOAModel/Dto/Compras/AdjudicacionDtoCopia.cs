...
{
    public class AdjudicacionDtoCopia // Es una copia de AdjudicacionDto. Necesaria para poder mapear objetos y campos que tiene que ver con entradas de servicio.
    {    
        ...
        public List<AdjudicacionPosicionDtoCopia> AdjudicacionPosiciones { get; set; } = new List<AdjudicacionPosicionDtoCopia>();
