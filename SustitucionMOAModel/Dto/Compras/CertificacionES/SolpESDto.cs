...
namespace SustitucionMOAModel.Dto
{
    public class SolpESDto
    {
        ...
        public List<SolpPosicionESDto> Posiciones { get; set; }
        ...
        public IEnumerable<SolpPosicionESDto> PosicionCompras { get; set; }
        public IEnumerable<SolpPosicionESDto> GrupoCompras { get; set; }
        public IEnumerable<SolpPosicionESDto> CentroCompras { get; set; }
        ...
        public SolpESDto(Solp entity)
        {
            ...
            this.Posiciones = new List<SolpPosicionESDto>();
    ...
    public class VisitaObraESDto
    {
        public string Codigo { get; set; }
        public DateTime FechaHora { get; set; }
        public VisitaObraESDto() { }
        public VisitaObraESDto(PliegoVisita entity)
        {
    ...
    public class RespuestaGuardarSOLPES
    {
    ...
    public class SolpPosicionESDto
    {
        public string Codigo { get; set; }
        ...
        public List<SolpSubposicionESDto> Subposiciones { get; set; }
        public List<SolpProveedorESDto> Proveedores { get; set; }
        public SustitucionMOAModel.Dto.ProvinciaDto Provincia { get; set; }
        ...
        public IEnumerable<SolpProveedorESDto> ProveedoresCompras { get; set; }
        public IEnumerable<SolpSubposicionESDto> SubposicionesCompras { get; set; }
        ...
        public SolpPosicionESDto() { }

        public SolpPosicionESDto(SolpPosicion entity)
        {
            if (entity != null)
            {
                ...
                this.Subposiciones = new List<SolpSubposicionESDto>();
                this.Proveedores = new List<SolpProveedorESDto>();
                ...
                this.Provincia = entity.ProvinciaId != null ? new SustitucionMOAModel.Dto.ProvinciaDto(entity.Provincia) : null;
                ...
                if (entity.Subposiciones != null)
                {
                    ...
                    {
                        this.Subposiciones.Add(new SolpSubposicionESDto(subpos));
                    }
                }
                ...
                if (entity.Proveedores != null)
                {
                    ...
                    {
                        this.Proveedores.Add(new SolpProveedorESDto(proveedor));
                    }
                }
            }
        }
    ...
    public class SolpSubposicionESDto
    {
        public int Indice { get; set; }
        public int Id { get; set; }
        public string Codigo { get; set; }
        ...
        public SolpSubposicionESDto() { }

        public SolpSubposicionESDto(SolpSubposicion entity)
        {
            if (entity != null)
            {
                this.Codigo = entity.Codigo;
    ...
    public class SolpProveedorESDto
    {
        public string Codigo { get; set; }
        ...
        public SolpProveedorESDto() { }

        public SolpProveedorESDto(SolpProveedor entity)
        {
            if (entity != null)
            {
    ...
    public class RespuestaCrearESOrdenDeCompra
    {
        public List<string> Errores { get; set; }
        public string Mensaje { get; set; }
        public int IdEntidad { get; set; }
