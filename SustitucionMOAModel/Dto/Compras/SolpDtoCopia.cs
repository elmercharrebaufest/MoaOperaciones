...
namespace SustitucionMOAModel.Dto
{
    public class SolpDtoCopia
    {
        ...
        public SolpDtoCopia() { }
        public SolpDtoCopia(Solp entity)
        {
    ...
    public class VisitaObraDtoCopia
    {
        public string Codigo { get; set; }
        public DateTime FechaHora { get; set; }

        public VisitaObraDtoCopia() { }

        public VisitaObraDtoCopia(PliegoVisita entity)
        {
    ...
    public class RespuestaGuardarSOLPCopia
    {
        public SolpDtoCopia Solp { get; set; }
    ...
    public class SolpPosicionDtoCopia
    {
        public string Codigo { get; set; }
        ...
        public SolpPosicionDtoCopia() { }

        public SolpPosicionDtoCopia(SolpPosicion entity)
        {
            if (entity != null)
            {
                this.Codigo = entity.Codigo;
    ...
    public class SolpSubposicionDtoCopia
    {
        public int Indice { get; set; }
        public int Id { get; set; }
        public string Codigo { get; set; }
        ...
        public List<string> ListMatDoc { get; set; }

        public SolpSubposicionDtoCopia() { }

        public SolpSubposicionDtoCopia(SolpSubposicion entity)
        {
            if (entity != null)
            {
                this.Codigo = entity.Codigo;
    ...
    public class SolpProveedorDtoCopia
    {
        public string Codigo { get; set; }
        ...
        public SolpProveedorDtoCopia() { }

        public SolpProveedorDtoCopia(SolpProveedor entity)
        {
            if (entity != null)
            {
    ...
    public class RespuestaCrearOrdenDeCompraCopia
    {
        public List<string> Errores { get; set; }
