...
namespace SustitucionMOAModel.Models.WSMapMOA.Compras
{
    public class ContratoSolp
    {
        ...
        public string CantidadPrevista { get; set; } //TARGET_QTY  KTMNG Cantidad prevista
        public string UnidadMedida { get; set; } //PO_UNIT BSTME Unidad de medida de pedido
        public string ImporteMonedaBapi { get; set; } //NET_PRICE BAPICUREXT  Importe de moneda para BAPIs(con 9 decimales)
        ...
        public string CantidadPositivoONegativo { get; set; } //MENGE MENGEV  Cantidad con signo +/-
        public string UnidadMedidaBase { get; set; } //MEINS MEINS   Unidad de medida base
        public string PrecioUnitario { get; set; } //TBTWR SBRTWR  Precio Unitario
        public string PrecioTotal { get; set; } //NETWR SNETWR  Precio total
