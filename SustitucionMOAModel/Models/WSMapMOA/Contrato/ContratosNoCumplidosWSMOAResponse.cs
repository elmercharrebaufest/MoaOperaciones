...
{
    public class ContratosNoCumplidosWSMOAResponse
    {
        ...
        public List<ContratoNoCumplidoView> contratosInfo { get; set; }

        public ContratosNoCumplidosWSMOAResponse()
        {
            ...
            this.contratosInfo = new List<ContratoNoCumplidoView>() { };
        }
    }

    public class ContratosNoCumplidosExcelWSMOAResponse
    {
        public ErrorWS error { get; set; }
        public List<string> contratos { get; set; }
        public List<string> vendedores { get; set; }
        ...
        public List<string> materiales { get; set; }
        public List<FechaStringWS> fechas { get; set; }
        public List<ContratoNoCumplido> contratosInfo { get; set; }

        public ContratosNoCumplidosExcelWSMOAResponse()
        {
            this.error = new ErrorWS();
            this.contratos = new List<string>() { };
            this.vendedores = new List<string>() { };
            ...
            this.materiales = new List<string>() { };
            this.fechas = new List<FechaStringWS>() { };
            this.contratosInfo = new List<ContratoNoCumplido>() { };
        }
    }
}
