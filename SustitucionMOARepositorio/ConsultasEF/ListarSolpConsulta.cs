            ...
            try
            {
                ...
                var resultado = from x in contexto.Set<Solp>()
                                ...
                                select new SolpDto
                                {
                                    ...
                                    VerPublicar = x.Posiciones.All(p => string.IsNullOrEmpty(p.NumeroContratoSuperior)) && (((x.EstadoSolpSap.CodigoSap == "05" || x.EstadoSolpSap.CodigoSap == "02") && x.TrabajoYaHecho != true && x.Adicional != true)
